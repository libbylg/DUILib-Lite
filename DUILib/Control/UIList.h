...
#define UILIST_MAX_COLUMNS 32
    ...
    typedef struct tagTListInfoUI
    {
        ...
        CStringUI sSelectedImage;
        DWORD dwHotTextColor;
        DWORD dwHotBkColor;
        CStringUI sHotImage;
        DWORD dwDisabledTextColor;
        DWORD dwDisabledBkColor;
        CStringUI sDisabledImage;
        DWORD dwLineColor;
        BOOL bShowRowLine;
    ...
    public:
        ...
        virtual TLISTINFO_UI* GetListInfo() = 0;
        ...
        virtual void DoEvent(struct TEVENT_UI& event) = 0;
    };
    ...
    {
        UI_DECLARE_CONTROL(CListHeaderUI)
    public:
        CListHeaderUI();
    ...
    {
        UI_DECLARE_CONTROL(CListHeaderItemUI)
    ...
    protected:
        ...
        CStringUI m_sSepImage;
        CStringUI m_sSepImageModify;
        int m_nScale;
    };
    ...
    {
        UI_DECLARE_CONTROL(CListLabelElementUI)
    public:
        CListLabelElementUI();
    ...
    {
        UI_DECLARE_CONTROL(CListTextElementUI)
    public:
        CListTextElementUI();
        ~CListTextElementUI();
    ...
    {
        UI_DECLARE_CONTROL(CListContainerElementUI)
    public:
