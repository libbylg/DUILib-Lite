...
namespace DUI
{
    ...
    UI_IMPLEMENT_CONTROL(CFadeButtonUI)

        CFadeButtonUI::CFadeButtonUI() : CAnimationUI(&(*this)), m_bMouseHove(FALSE), m_bMouseLeave(FALSE)
    {
    }
    ...
    void CFadeButtonUI::DoEvent(struct TEVENT_UI& event)
    {
